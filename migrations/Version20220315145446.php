 ...
 */
final class Version20220315145446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD customer_id_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955B171EB6C FOREIGN KEY (customer_id_id) REFERENCES `user` (id)');
